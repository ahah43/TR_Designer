...
async function run() {
    ...
    runBotton.onclick = function () {
        ...
        let minD = Number(document.getElementById("minD").value);
        let maxD = Number(document.getElementById("maxD").value);
        // console.log('new iteration, minD = ', minD);
        // console.log('new iteration, maxD = ', maxD);
        for (let core_d_value = minD; core_d_value <= maxD; core_d_value++) {
            console.log('new iteration, core_d_value = ', core_d_value);
            results = my_tr_designer(
                ...
                core_d_value,// Number(document.getElementById("maxD").value),
                core_d_value, //Number(document.getElementById("minD").value),
